...
public class WeekFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTextView = (TextView)view.findViewById(R.id.no_week_article);
        mRecyclerView = (RecyclerView)view.findViewById(R.id.week_recycler);
    ...
    public void requestContent(int cateId,int sourceId, int row){
        proDialog.show();
        String url = Util.BASE_URL + "/api/article/statistic/" + cateId + "/"+ sourceId +"/7/" + row;
